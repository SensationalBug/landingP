                            ...
                            <Grid item xs={12} md={4}>
                                <Stack spacing={{ xs: 2, md: 5 }}>
                                    ...
                                    <Typography variant="body2" color={textColor}>
                                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Incidunt pariatur natus, saepe quam voluptates veniam mollitia rem soluta temporibus cum voluptatibus. Ullam officiis doloremque optio. Quisquam, delectus! Ullam, veritatis expedita.
                                    </Typography>
                                </Stack>
                            </Grid>
                                        ...
                                        <Stack spacing={{ xs: 3, md: 5 }}>
                                            ...
                                            <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                                                {frameworks.map((item, index) => (
                                                    <FooterLink href={item.link} underline="none" key={index}>
                                                        {item.title}
                                                        {item.isUpcoming && (
